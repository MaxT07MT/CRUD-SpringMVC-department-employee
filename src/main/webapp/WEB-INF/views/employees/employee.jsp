    ...
    <div class="w3-card-4">
        ...
        <div class="w3-container w3-white w3-right-align">
            ...
            <div class="w3-container w3-yellow w3-opacity w3-right-align w3-padding">
                <button class="w3-btn w3-hover-green w3-round-large" onclick="location.href='/departments/${depId}/employees/newEmp'">Add Employee</button>
                ...
                <tr>
                    ...
                    <TD>
                        <div class="w3-container w3-white w3-opacity w3-right-align w3-padding">
                            <button class="w3-btn w3-green w3-round-large" onclick="location.href='/departments/${employee.depId}/employees/${employee.id}/empShowById'">Info</button>
                        </div>
